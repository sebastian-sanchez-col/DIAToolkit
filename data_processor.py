...
if __name__ == "__main__":
    ...
    df_scholarship = pd.read_csv('sources/Beneficiaros_de_becas_y_creditos_de_programas_de_acceso_a_la_educación_superior_de_Antioquia_20260617.csv')
    ...
    df_utility_subsidy = pd.read_csv('sources/Subsidios_y_Contribuciones_de_Servicios_Públicos_Domiciliarios_–_EPM_20260617.csv')
    ...
    df_investment_by_commune_and_district = pd.read_csv('sources/inversion_por_comunas_y_corregimientos_2017_medellin.csv')
    ...
    df_social_inclusion_actions_for_people_with_disabilities = pd.read_csv('sources/implementacion_acciones_personas_discapacidad_familiares_cuidadores_2023.csv')

    print(df_scholarship.head())
    print(df_utility_subsidy.head())
    ...
    print(df_scholarship.columns.tolist())
    print(df_scholarship.iloc[:, 0].unique())
